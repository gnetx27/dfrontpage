...
import img_off from '../../util/img/61off.svg';
...
function SchoolCourseBody(){
    return (
        <>
            <div className="bg-[#FFF0DE] pt-5 text-[#FFA639]">
...
<div className="grid md:grid-cols-4 gap-14 md:gap-5 p-3">
          <div data-aos="fade-up" className="pb-2 bg-white shadow-xl  rounded-xl aos-init hover:bg-red">
              <div className="p-3">
                  <b className="text-left">K-2 Plan</b>
                  <div>
                  <div className="px-5">

                  <li>15 Icon & Block Coding Courses</li>
                  <li>iPad and Web</li>
                  <li>Voiceovers</li>
                  <li>No-typing SmartPass Login</li>
                  <li>School Progress Metrics</li>
                  <li>School Year Plan</li>

                    $15/student (50 student min)
            ...
            <img src={img_lineor}/>
              <div className="flex">
                <div className="text-left w-[50%] px-4">
                    <b>$2,000</b> per shcool up to 600 students
                </div>
