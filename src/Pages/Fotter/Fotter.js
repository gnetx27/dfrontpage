import logo from '../util/img/logo2.svg';

const Fotter=()=>{
    return (
	
        <footer className="bg-[#29405B] pt-20">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-10 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" className="flex items-center">
                        <img src={logo} className="h-8 mr-3" alt="FlowBite Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Dynamo</span>
                    </a>
                    </div>
                ...
                <hr className="my-6 border-black-200 sm:mx-auto dark:border-black-100 lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm sm:text-center ">© 2023 <a href="" className="hover:underline">Dynamo</a>. All Rights Reserved.
                    </span>
