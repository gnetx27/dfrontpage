...
return (
		...
		<div class="shadow-md max-w-screen-xl pr-8 mx-auto flex flex-col lg:flex-row items-start h-[350px] sm:h-[400px] md:h-[580px] bg-no-repeat bg-cover bg-center  md:bg-none" style={{ 'backgroundImage': `url(${img_bg_2})`}}>
		
			<div class="absolute w-full">
				<div class="related top-0 left-0 w-[30%] sm:w-[35%] md:w-[40%] lg:[45%] xl:[50%] ">
