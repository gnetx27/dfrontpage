import img_banner_image from '../../util/img/parent_girl.png';
import img_banner_logo from '../../util/img/banner_logo_se.svg';
import img_banner_logo2 from '../../util/img/PictoBlox-Cover-Image.png';

function BannerParent(){
	return (
		<div class="bg-[#D6DADC]">
		
		<div class="max-w-screen-xl pr-8 mx-auto flex flex-col lg:flex-row items-start">
			...
			<div class="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
				...
				<h1 data-aos="fade-right" data-aos-once="true" className="my-4 text-5xl font-bold leading-tight text-darken pl-5">
					Connecting  Classroms<br/><span className="text-yellow-500"> lessons with</span><br/>
					<span className="text-yellow-500">Real</span> World Problem
				</h1>
				{ /*
			...
			{/*<!--Right Col-->*/}
			<div class="w-full lg:w-6/12 lg:-mt-10 relative text-red" id="girl" >
				...
				<div data-aos="fade-up" data-aos-delay="600" data-aos-once="true" class="absolute bottom-20 md:bottom-48 lg:bottom-52 -right-6 lg:right-8 floating-4">
					<img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" src={img_banner_logo2} alt="" />
				</div>
