import img_banner_image from '../../util/img/curse_banner_img.png';
import img_banner_logo from '../../util/img/curse_banner_logo.svg';

function BannerCourse(){
	return (
		<>
		<div class="bg-gray-100 relative max-w-screen-xl pr-8  flex flex-col lg:flex-row items-start">			
			<img  data-aos="fade-up" data-aos-once="true" class="absolute left-0 top-0  w-96 h-96" src={img_banner_logo} alt="img"/>

			{/**<!--Left Col-->**/}
			<div class="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
				
				<h1 data-aos="fade-right" data-aos-once="true" className="my-4 text-5xl font-bold leading-tight text-darken pl-5">
					<span className="text-yellow-500">Connecting</span> Classroms with<br/>
					Real World Problem
				</h1>
				{ /*
			...
			<div class="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
				...
				<div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="absolute top-20 -left-6 sm:top-32 sm:left-10 md:top-40 md:left-16 lg:-left-0 lg:top-52 floating-4">
					<img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" src="img/calendar.svg" alt="img"/>
				</div>
				{/*<!-- red -->*/}
				...
				<div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="absolute bottom-14 -left-4 sm:left-2 sm:bottom-20 lg:bottom-24 lg:-left-4 floating">
					<img class="bg-white bg-opacity-80 rounded-lg h-20 sm:h-28" src="img/ux-class.svg" alt="img" />
				</div>
				{/*<!-- congrats -->*/}
				<div data-aos="fade-up" data-aos-delay="600" data-aos-once="true" class="absolute bottom-20 md:bottom-48 lg:bottom-52 -right-6 lg:right-8 floating-4">
					<img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" src="img/congrat.svg" alt="img" />
				</div>
			</div>
		</div>
	</>
