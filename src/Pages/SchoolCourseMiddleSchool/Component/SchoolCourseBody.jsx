...
import img_off from '../../util/img/67off.svg';
import img_lineor from '../../util/img/lineor.svg';


function SchoolCourseMiddleSchool(){
    return (
        <>
...
<div className="grid md:grid-cols-4 gap-14 md:gap-5 p-3">
          ...
          <div data-aos="fade-up" className="pb-2 bg-white shadow-xl  rounded-xl aos-init hover:bg-red">
              ...
              <div className="p-3">
                  ...
                  <div>
                  <div className="px-5">
                  <li>19 Block & Text Coding Courses</li>
                  <li>Lesson Plans</li>
            ...
            <img src={img_lineor}/>
              <div className="flex">
                <div className="text-left w-[50%] px-4">
                    <b>$4,400</b> per shcool up to 600 students
                </div>
...
export default SchoolCourseMiddleSchool;
