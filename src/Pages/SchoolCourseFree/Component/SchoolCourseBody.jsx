...
import img_off from '../../util/img/71off.svg';
...
<div className="grid md:grid-cols-4 gap-14 md:gap-5 p-3">
          ...
          <div data-aos="fade-up" className="pb-2 bg-white shadow-xl  rounded-xl aos-init hover:bg-red">
              ...
              <div className="p-3">
                  ...
                  <div>
                  <div className="px-5">
                    <li>4 Free Coding Courses</li>
                    <li>Free Weekly STEM Projects</li>
                    <li>Free Hour of Code Activities</li>
                    <li>Free Project Templates</li>
                    <li>Free Coding Tools (Block & Text)</li>
                    <li>Unlimited Student Accounts</li>
                    <li>Student Progress Metrics</li>
                    <li>Free Professional Development</li>              
                  </div>
                  </div>
              </div>
