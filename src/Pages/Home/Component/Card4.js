...
import img_card from   '../../util/img/Card/card.png';
import img_card_1 from '../../util/img/Card/card1.svg';
import img_card_2 from '../../util/img/Card/card2.svg';


function Card4(){
    return (
        <div className="grid md:grid-cols-4 gap-14 md:gap-5 mt-20 ">
          <div data-aos="fade-up" className="bg-white shadow-xl p-6 text-center rounded-xl aos-init ">
             <img 
              className="rounded "
              src={img_card_1}
              alt="img"
              />
            <p className="text-gray-500">Learn Science, Coding and Robotics</p>
          </div>
          <div data-aos="fade-up" data-aos-delay={150} className="bg-white shadow-xl p-6 text-center rounded-xl aos-init">
            ...
            <p className="px-4 text-gray-500">Teach subject based STEM courses For your school</p>
          </div>
          <div data-aos="fade-up" data-aos-delay={300} className="bg-white shadow-xl p-6 text-center rounded-xl aos-init">
            ...
            <p className="px-4 text-gray-500">Project And Research Consultant</p>
          </div>
          <div data-aos="fade-up" data-aos-delay={350} className="bg-white shadow-xl p-6 text-center rounded-xl aos-init">
            <img 
              className="rounded"
              src={img_card_2}
              alt="img"
              />
            <p className="px-4 text-gray-500">Books and Education kit</p>
          </div>
        </div>
    )
}
