import img_1 from '../../util/img/Rectangle19.png';
import img_2 from '../../util/img/Rectangle21.png';

function Skill(){
    return (
        <div className="mt-28">
          <div data-aos="flip-down" className="text-center max-w-screen-md mx-auto aos-init">
          ...
          <div data-aos="fade-up" className="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7 aos-init">
            <div className="relative md:w-5/12">
              <img className="rounded-2xl" src={img_1} alt="" />
            ...
            <div className="relative md:w-5/12">
              <img className="rounded-2xl" src={img_2} alt="" />
              <div className="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
